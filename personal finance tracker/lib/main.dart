...
void main() async {
  ...
  try {
    ...
    if (kIsWeb) {
      ...
      // Use web-specific database factory
      databaseFactory = databaseFactoryFfiWeb;
    } else if (defaultTargetPlatform == TargetPlatform.android ||
               defaultTargetPlatform == TargetPlatform.iOS) {
      debugPrint('Initializing Mobile database...');
      // On Android/iOS, use default sqflite (no special initialization needed)
    } else {
      debugPrint('Initializing Desktop database...');
      // On Desktop (Windows/Linux/Mac), use sqflite_common_ffi
      sqfliteFfiInit();
